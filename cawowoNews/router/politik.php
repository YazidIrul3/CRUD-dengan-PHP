<?php 
    ...
    $new_news =  select("SELECT * FROM news WHERE category='Politik' ORDER BY id DESC LIMIT 6");
    $all_news =  select("SELECT * FROM news where category='Politik'");
?>
